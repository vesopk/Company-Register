...
namespace CompanyRegister.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddDbContext<CompanyRegisterDbContext>(options =>
            //    options.UseSqlServer(
            //        Configuration.GetConnectionString("CompanyRegisterConnection")));

            services.AddTransient<CompanyServices>();
            services.AddTransient<EmployeeServices>();
            services.AddTransient<InternServices>();
